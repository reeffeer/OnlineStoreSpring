...
public class UnproductiveCameraRollBeanFactoryPostProcessor implements BeanFactoryPostProcessor {
    @Override
...
*  содержит ли он аннотацию UnproductiveCameraRoll
*/
...
*/
                UnproductiveCameraRoll annotation = (UnproductiveCameraRoll)beanClass.getAnnotation(UnproductiveCameraRoll.class);
